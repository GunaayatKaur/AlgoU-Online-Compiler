...
function App() {
  ...
  return (
    <div className="container mx-auto py-8 flex flex-col items-center">
      <h1 className="text-3xl font-bold mb-4 text-white">AlgoU Online Code Compiler</h1>
      ...
      <br />
      <div className="bg-gray-100 shadow-md w-full max-w-lg mb-4" style={{ height: '400px', overflowY: 'auto' }}>
        <Editor
          value={code}
